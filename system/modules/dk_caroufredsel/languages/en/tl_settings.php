 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_settings']['dk_cfsTriggerMode']		= array('JavaScript Startmethode', 'Falls die Elemente nicht korrekt dargestellt werden, kann es helfen das JavaScript schon beim Laden der Seite zu starten.');
