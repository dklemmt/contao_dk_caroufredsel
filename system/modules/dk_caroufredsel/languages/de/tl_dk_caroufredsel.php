...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['scrollQueue']			= array('Warteschlange', 'Bestimmt wie mit weiteren eintreffenden Scroll-Ereignissen verfahren wird, während das Karussell scrollt.');
...
$GLOBALS['TL_LANG']['tl_dk_caroufredsel']['itemsVisibleSelect']		= array('Anzahl sichtbarer Elemente', 'Bestimmt die Art wie die Anzahl der sichtbaren Elemente ermittelt wird. Wählen Sie nichts wird dies automatisch berechnet.');
