...
$GLOBALS['TL_LANG']['tl_settings']['dk_cfsTriggerMode']['readyLoad']		= array('readyLoad', 'Diese Erweiterung ist eine Kombination der beiden anderen Modi. Das Karussell wird wie bei onDocumentReady initialisiert und danach kontinuierlich erneut bis nach onWindowLoad. Es wird das jQuery Plugin "jquery.readyLoad.js" eingebunden.');
